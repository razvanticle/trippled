    ...
    public abstract class ValueObjectBase<TObject> : IEquatable<TObject> where TObject : class
    {
        ...
        public virtual bool Equals(TObject other)
        {
            ...
            foreach (FieldInfo field in fields)
            {
                ...
                {
                    string dateString1 = ((DateTime) otherValue).ToString(CultureInfo.InvariantCulture);
                    string dateString2 = ((DateTime) thisValue).ToString(CultureInfo.InvariantCulture);
